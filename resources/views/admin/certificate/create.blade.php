                            ...
                            <table class="table table-flus datatable-basic">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">is certificate?
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="form-group">
                ...
                <select class="form-select w-50" name="selected">
                    <option selected>Select student</option>
                    @foreach($listUser as $x)
                    <option value="{{$x->id}}">{{$x->user->full_name}} with subject -> {{$x->subject->name}}</option>
                    @endforeach
                </select>
            </div>
            <a href="/certificate" type="button" class="btn btn-outline-primary btn-sm mb-0">
                Back
            </a>
