                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <a href="/quiz-create" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp;
                                    New Quiz
                                </a>
                            </div>
                        </div>
                    ...
                    <table class="table table-flus datatable-basic">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Subject Name
                                </th>
                            ...
                            @foreach ($data as $x)
                                <tr>
                                    ...
                                    <td class="text-sm font-weight-normal">
                                        {{ $x->session->subject->name }}
                                    </td>
                                    <td class="text-sm font-weight-normal">
                                        {{ $x->session->session_no }}
                                    </td>
                                    <td class="text-sm font-weight-normal">
                                        {{ $x->duration / 60 / 60 }} Hour(s)
                                    </td>
                                    <td class="text-sm col-lg-2">
                                        <a href="/quiz-edit/{{ $x->id }}" class="mx-3" data-bs-toggle="tooltip"
                                            data-bs-original-title="Edit">
                                            <i class="fas fa-user-edit text-secondary" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" class="delete-quiz" data-id="{{ $x->id }}" type="button"
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        window.location = "/quiz-destroy/" + id + "";
